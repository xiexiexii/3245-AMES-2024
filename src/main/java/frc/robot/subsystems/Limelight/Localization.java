...
public class Localization extends SubsystemBase {
  ...
  // Limelights
  private static String[] limelightNames = {"limelight"};
  ...
  public static LimelightPoseEstimateWrapper[] getPoseEstimates(double headingDegrees) {
    ...
    for (int i = 0; i < limelightNames.length; i++) {
      ...
      LimelightHelpers.SetRobotOrientation(name, headingDegrees + SwerveSubsystem.AllianceYaw, SwerveSubsystem.swerveDrive.getGyro().getRate(), 0, 0, 0, 0);
  ...
  public static Pose2d getPose2d() { 
    return SwerveSubsystem.swerveDrive.getPose();
  }
